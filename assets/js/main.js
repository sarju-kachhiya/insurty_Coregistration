...
$(document).ready(function() {
    // step list group item click
    $(".ci-rate-step .ci-form-submit-btn").on("click", function() {
        $('.ci-rate-step').removeClass('active');
        $(this).closest('.ci-rate-step').next().addClass('active');
    });

    // step back in click on back btn
    $(".ci-rate-step .ci-form-back-btn").on("click", function() {
        $('.ci-rate-step').removeClass('active');
        $(this).closest('.ci-rate-step').prev().addClass('active');
    });
